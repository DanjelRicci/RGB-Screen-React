...
**ATTENTION**: to make sure the background process works correctly on boot, go to Configuration > General Settings > Advanced Settings and enable *User init scripts*.
